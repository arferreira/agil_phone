...
<head>
    ...
    <meta name="author" content="Antônio Ricardo">
	<!--title-->
    <title>AgilPhone | Agilidade e Rapidez na manutenção de seu Smartphone</title>
	
	<!--CSS-->
    <link href="<?php base_url(); ?>assets/css/bootstrap.min.css" rel="stylesheet">
    <link href="<?php base_url(); ?>assets/css/font-awesome.min.css" rel="stylesheet">
    <link href="<?php base_url(); ?>assets/css/font.css" rel="stylesheet">
    ...
    <![endif]-->       
    <link rel="shortcut icon" href="<?php base_url(); ?>assets/images/ico/favicon.png">
